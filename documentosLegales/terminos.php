...
<head>
    ...
    <title>Terminos y privacidad</title>
    <link rel="stylesheet" href="terminos.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="seleccionIdioma.css?v=<?php echo time(); ?>">
</head>
...
<body>
    <div>
        ...
        <div class="campoMultiple">
            <div class="radio-inputs">
                <label class="radio" id="labelIdioma">
                    <input type="radio" name="Idioma" value="castellano" checked="">
        ...
        <div class="introduccion">
            ...
            <h2 class="subtitulo">GENERALIDADES</h2>

            <p>Unimatch gestiona este sitio web. En todo el sitio, los términos "nosotros", "nos" y "nuestro" se refieren en lo sucesivo a unimatch. unimatch ofrece esta página web, incluida toda la información, las herramientas y los servicios que se ponen en este sitio a disposición suya, el usuario, siempre y cuando acepte la totalidad de los términos, condiciones, políticas y avisos contemplados aquí.</p>
            ...
            <p>Nuestra aplicación está alojada en wordpress.com. Nos las herramientas necesarias para publicar nuestra aplicación y ofrecer nuestros servicios.</p>

            <hr>
        </div>
        <div class="seccion">

            <h2 class="subtitulo">SECCIÓN 1: TÉRMINOS DE LA APLICACIÓN</h2>
        ...
        <div class="seccion">
            ...
            <h2 class="subtitulo">SECCIÓN 2: CONDICIONES GENERALES</h2>
        ...
        <div class="seccion">
            ...
            <h2 class="subtitulo">SECCIÓN 3: EXACTITUD, TOTALIDAD Y CRONOLOGÍA DE LA INFORMACIÓN</h2>
        ...
        <div class="seccion">
            ...
            <h2 class="subtitulo">SECCIÓN 4: MODIFICACIONES AL SERVICIO Y PRECIOS</h2>

            <p>Los precios de nuestros productos se mantendrán disponibles de forma gratuita en su totalidad hasta aviso previo.</p>

            <p>Nos reservamos el derecho de modificar o discontinuar el Servicio (o cualquier parte o contenido del mismo) siempre con un aviso anticipado.</p>
        ...
        <div class="seccion">
            ...
            <h2 class="subtitulo">SECCIÓN 5: PRODUCTOS O SERVICIOS (si corresponde)</h2>
