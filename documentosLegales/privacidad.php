...
<body>
    ...
    <div class="introduccion">
        <hr>
        <p>El presente Política de Privacidad establece los términos en que Unimatch usa y protege la información que es
    ...
    <div class="seccion">
        ...
        <h2 class="subtitulo"><strong>Información que es recogida</strong></h2>
    ...
    <h2 class="subtitulo"><strong>Uso de la información recogida</strong></h2>
    <div class="seccion">
        <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
            ...
            cualquier momento.</p>
        <p>Unimatch está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los
            sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
        </p>
    </div>
    <div class="seccion">
        <h2 class="subtitulo"><strong>Cookies</strong></h2>
        ...
        <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
            ...
            menos de que usted así lo quiera y la proporcione directamente <a href="" target="_blank"></a>. Usted puede aceptar
    ...
    <div class="seccion">
        ...
        <p>Unimatch Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
        </p>
